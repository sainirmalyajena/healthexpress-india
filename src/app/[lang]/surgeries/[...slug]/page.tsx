...
export default async function SurgeryDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-md border-t border-slate-100 px-4 py-2.5 md:hidden">
        <a
          href={`https://wa.me/919307861041?text=${whatsappMsg}`}
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-full items-center justify-center gap-2 bg-[#25D366] text-white font-bold py-2.5 rounded-xl text-sm"
        >
